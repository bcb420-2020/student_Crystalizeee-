...
bioconductor_packages <- setdiff(bioconductor_packages, rownames(installed.packages()))
...
<br>
First the whole gene list was divided into upregulated gene list and downregulated gene list.
```{r}
